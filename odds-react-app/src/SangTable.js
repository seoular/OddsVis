...
import {calculateMeanAndStdDev, calculatePercentile, getQueryStringValue, rainbow} from './util.js'
          ...
          <tr>
            <td
              style={{
                ...
                color: 
                 x.percentile > 77.5 && x.percentile < 82 ? "lightgrey" : "white",
            ...
            {getQueryStringValue('isPro')=='thanksdude' ? 
              <>
                <td
                  style={{
                    backgroundColor: x.calculatedColor,
                    color: x.percentile > 77.5 && x.percentile < 82 ? "lightgrey" : "white",
                    border: "1px solid " + x.calculatedColor,
                    borderRadius: "10px",
                    width: "100px"
                  }}
